...
def test_seidel_method_line(test_data_line):
    ...
    assert abs(nodes[2].voltage - complex(109.991, -4.329)) < 1e-3
...
def test_seidel_method_t3(test_data_t3):
    ...
    assert abs(nodes[1].voltage - complex(124.148, -2.732)) < 1e-3
    assert abs(nodes[2].voltage - complex(11.273, -0.281)) < 1e-3